...
You can start using Aws-s3 directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Aws-s3.
...
The full list of available tools is at [./src/universal_mcp_aws_s3/README.md](./src/universal_mcp_aws_s3/README.md)
