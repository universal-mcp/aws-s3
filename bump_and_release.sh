...
echo "Generating tools README for src/universal_mcp_aws_s3/app.py..."
universal_mcp readme src/universal_mcp_aws_s3/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_aws_s3/README.md
